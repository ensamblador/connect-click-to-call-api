...
class api_cors_lambda(core.Construct):
    def __init__(self, scope: core.Construct, id: str, api_name, resource_name, method, base_lambda, **kwargs) -> None:
        super().__init__(scope, id, **kwargs)

        base_api = _apigw.RestApi(self,'ApiGatewayWithCors',rest_api_name = api_name)
        resource = base_api.root.add_resource(resource_name)
